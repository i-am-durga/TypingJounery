            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, idx) => (
                        ...
                        >
                            <div className="mb-6 inline-flex items-center justify-center w-14 h-14 rounded-xl bg-white/5 border border-white/10 group-hover:scale-110 group-hover:bg-white/10 transition-all duration-300">
                                {feature.icon}
                            </div>
                ...
                <div className="mt-24 pt-12 border-t border-white/10 grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div className="text-center">
                        ...
                        <div className="text-gray-400 text-sm uppercase tracking-wider">Active Learners</div>
                    </div>
                    <div className="text-center">
                        <div className="text-4xl font-black text-primary mb-2">+35</div>
                        <div className="text-gray-400 text-sm uppercase tracking-wider">Avg WPM Improvement</div>
                    </div>
                    <div className="text-center">
                        <div className="text-4xl font-black text-secondary mb-2">3</div>
                        <div className="text-gray-400 text-sm uppercase tracking-wider">Supported Languages</div>
                    </div>
                    <div className="text-center">
                        <div className="text-4xl font-black text-white mb-2">10M+</div>
                        <div className="text-gray-400 text-sm uppercase tracking-wider">Lessons Completed</div>
                    </div>
                </div>
            </div>
        </section>
